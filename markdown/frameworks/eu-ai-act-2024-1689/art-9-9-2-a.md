...
SAFE-K8S threat modeling controls (STRIDE, OCTAVE, MITRE ATT&CK mapping) in D10 KA 10.3 address infrastructure and AI-specific threat identification. Health, safety, and fundamental rights risk analysis is an application-layer and organizational concern.
